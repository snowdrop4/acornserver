...
def create_random_category(parent: ForumCategory) -> tuple[ForumCategory, dict]:
    data = {"category-title": random_str(), "category-folder": False}
...
def create_random_thread(
    category: ForumCategory, author: User
) -> tuple[ForumThread, dict]:
    data = {"thread-title": random_str(), "thread-body": random_prose()}
...
def create_random_post(
    category: ForumCategory, thread: ForumThread, author: User
) -> tuple[ForumPost, dict]:
