        ...
        for (group_name, models) in groups.items():
            ...
            for (model, verbs) in models.items():
                for verb in verbs:
                    ...
                    # Get the ContentType of the model for the permission we
                    # are trying to set.
                    #
                    # We can use the ContentType of the model to disambiguate
                    # in case there happens to be two models from different
                    # apps that have the same name.
