...
urlpatterns = [
	...
	path('music/release_group/delete/<int:pk>',    release_group.delete,    name='music_release_group_delete'),
	...
	path('music/contribution/delete/<int:pk>',    contribution.delete,    name='music_contribution_delete'),
	...
	path('music/release/delete/<int:pk>',    release.delete,    name='music_release_delete'),
	...
	path('music/torrent/delete/<int:pk>',   torrent.delete,   name='music_torrent_delete'),
